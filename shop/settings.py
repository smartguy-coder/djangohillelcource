...
REST_FRAMEWORK = {
    ...
    'PAGE_SIZE': 3,  # Кількість елементів на сторінку
}
...
SPECTACULAR_SETTINGS = {
    ...
    # This will display a Bearer token input in the Swagger UI
    'SECURITY': [{'bearerAuth': []}],  # Стандартний заголовок Authorization: Bearer <token>

    'SECURITY_SCHEMES': {
        'bearerAuth': {
            'type': 'http',
            'scheme': 'bearer',
            'bearerFormat': 'JWT',  # Або інший формат токена, якщо потрібно
        },
    },
}
